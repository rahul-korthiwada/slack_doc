...
identity_objects[EMAIL]["regex"] = r"[\w.]+[@][\w.]+[\w]" # something.someone@identity.email.something.com we dont need dashes
...
identity_objects[VPA]["regex"] = r"[\w.]{3,256}@[\w]{3,64}"
...
identity_objects[PAN]["regex"] = r"[a-zA-Z]{5}[0-9]{4}[a-zA-Z]"
...
identity_objects[CVV]["regex"] = r"\d{3-4}"
...
identity_objects[EXPIRY]["regex"] = r"(0[1-9]|1[012])[\ /-]((\d{2})|(20[0-9][0-9]))"
...
identity_objects[UID]["regex"] = r"((\\\*)(\"|\')|(>))\d{12}((<)|(\\\*)(\"|\'))"
...
identity_objects[EXPIRY_MONTH]["regex"] = r"((\\\*)(\"|\')|(>))(0[1-9]|1[012])((<)|(\\\*)(\"|\'))"
...
identity_objects[EXPIRY_YEAR]["regex"] = r"((\\\*)(\"|\')|(>))((\d{2})|(20[0-9][0-9]))((<)|(\\\*)(\"|\'))"
...
identity_objects[CARD]["regex"] = r"\d{12,19}"
...
identity_objects[ACCOUNT]["regex"] = r"\d{9,18}"
...
identity_objects[GSTIN]["regex"] = r"((\\\*)(\"|\')|(>))[0-9]{2}[a-zA-Z]{5}[0-9]{4}[a-zA-Z][a-zA-Z0-9][zZ][a-zA-Z0-9]((<)|((\\\*)(\"|\')))"
...
identity_objects[ACCESS_TOKEN]["regex"] = r"[A-Za-z0-9_=]+\.[A-Za-z0-9_=]+\.[A-Za-z0-9_=]+"
...
identity_objects[REFRESH_TOKEN]["regex"] = r"[a-z0-9]+"
...
identity_objects[PUBLIC_TOKEN]["regex"] = r"[a-zA-Z0-9_]+"
...
identity_objects[SECRET]["regex"] = r"[A-Z0-9]+"
...
identity_objects[AUTHORIZATION_KEY]["regex"] = r"Basic[\w=]+="
